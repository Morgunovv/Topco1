...
import MenuPopover from "../../MenuPopover"; // plasmic-import: t563NuQ3dnUr/component
import MenuItem from "../../MenuItem"; // plasmic-import: T2u9UxC3Owqa/component
import MenuSection from "../../MenuSection"; // plasmic-import: E6OgdK8R1phB/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: RmoZ-FB3YaYT/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yLlMx)}>
        {(() => {
          const child$Props = {
