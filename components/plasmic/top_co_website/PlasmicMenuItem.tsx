...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: T2u9UxC3Owqa/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fjGwg)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__rcGfy)}>
            <div
              className={classNames(
                projectcss.all,
