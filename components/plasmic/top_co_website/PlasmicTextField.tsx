...
import Label from "../../Label"; // plasmic-import: l44H9L0eZgdK/component
import TextInput from "../../TextInput"; // plasmic-import: XhUZaLCwsrvr/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: QebLBMqPrgvK/component
import Description from "../../Description"; // plasmic-import: 6SBZnFE2vPt8/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 9GMzyt8JTy4M/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___5U6FR, {
          [sty.freeBoxiconEnd___5U6FR5BZz]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___5U6FRy93UP]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___5U6FRgRxhp]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__bluzy, {
            [sty.freeBoxiconStart__bluzyY93UP]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__bluzygRxhp]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qU7Ln)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__fKJa0, {
            [sty.freeBoxiconEnd__fKJa05BZz]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__fKJa0Y93UP]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__rJu8U)}
                role={"img"}
              />
            ),
