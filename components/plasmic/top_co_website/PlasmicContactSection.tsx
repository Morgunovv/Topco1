...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: 4un3pt4AfjWC/css

import RightArrowIcon from "./icons/PlasmicIcon__RightArrow"; // plasmic-import: WugXrm4_MYzK/icon
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___9Z5Ae)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xIhHw)}>
          <PlasmicLink__
