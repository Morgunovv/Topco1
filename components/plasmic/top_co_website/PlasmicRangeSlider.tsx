...
import SliderThumb from "../../SliderThumb"; // plasmic-import: zTnG5uichMbB/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: CHKolLL000gz/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__nGfA2)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox___30ZC1)}>
        <div
