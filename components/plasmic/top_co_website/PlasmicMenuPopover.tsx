...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: t563NuQ3dnUr/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__qTFg)}
                    value={"item1"}
                  />
