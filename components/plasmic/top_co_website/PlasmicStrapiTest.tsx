...
import { Hover1Value, useHover1 } from "./PlasmicGlobalVariant__Hover1"; // plasmic-import: fAPDPpdFLvKh/globalVariant
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          [sty.rootglobal_hover1_interactionStates]: hasVariant(
            globalVariants,
            "hover1",
            "interactionStates"
          )
